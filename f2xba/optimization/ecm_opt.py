...
class EcmOptimization(Optimize):
    ...
    def single_gene_deletion(self, gene_list=None, method='ecm', solution=None, **kwargs):
        """Single gene deletion for ECM based models using gurobipy interface.

        Same function as for FBA SGKO simulation
        ...
        If the RBA wild type solution is not provided, a wild type solution will be determined.
        ...
        :param str method: (optional) 'ecm', 'moma', 'linear moma', 'room', 'linear room'
